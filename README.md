...
- **데이터베이스**: psycopg2, elasticsearch, MongoDB, InfluxDB, Redis
- **메시징**: fastavro, Schema Registry, zstandard
- **AI/ML**: OpenAI 프로바이더
- **스트림 처리**: Apache Flink 프로바이더
...
│   │   │   ├── mmix-mysql-source-connector.json  # Debezium MySQL CDC
│   │   │   └── mmix-s3-sync-connector.json       # Confluent S3 Sink
│   │   ├── 01_example_mysql_replica_.ipynb     # MySQL Replication
│   │   ├── 02_example_mysql_faker.ipynb        # 더미 데이터 생성
│   │   ├── 03_example_pandas.ipynb             # Pandas 분석
│   │   ├── 04_example_duckdb.ipynb             # DuckDB 쿼리
│   │   ├── 05_example_kafka.ipynb              # Kafka JSON
│   │   ├── 06_example_kafka_avro.ipynb         # Kafka Avro
│   │   ├── 07_example_kafka_connet.ipynb       # Kafka Connect
│   │   ├── 99_example_elasticsearch.ipynb      # Elasticsearch
│   │   └── 99_example_msk.ipynb                # AWS MSK
...
```bash
pip install jupyterlab kafka-python==2.3.0 apache-airflow==3.1.6 -r requirements/requirements.txt
```
